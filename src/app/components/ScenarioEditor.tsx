...
import { useScenarios, Scenario, SCENARIO_TEMPLATES } from '../../lib/useScenarios'
                    ...
                    return (
                      <div key={key}>
                        ...
                        <input
                          ...
                          className="w-full bg-slate-800/30 border border-slate-700 rounded-lg py-2 px-3 text-slate-200 focus:outline-none focus:ring-2 focus:ring-violet-500 text-sm"
                        />
                      </div>
                    );
                  })}
